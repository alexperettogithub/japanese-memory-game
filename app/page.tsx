      ...
      <nav className="site-menu" aria-label="Account and social links">
        ...
        <div className="site-menu-panel" id="site-menu-panel">
          ...
          <div className="social-links" aria-label="Social links coming soon">
            <button type="button" aria-label="X profile coming soon" data-social="X">
            ...
            <button type="button" aria-label="Instagram profile coming soon" data-social="Instagram">
            ...
            <button type="button" aria-label="GitHub profile coming soon" data-social="GitHub">
