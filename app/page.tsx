      ...
      <nav className="site-menu" aria-label="Account and social links">
        ...
        <div className="site-menu-panel" id="site-menu-panel" hidden>
          ...
          <div className="social-links" aria-label="Social links coming soon">
            <a href="#" aria-label="X profile coming soon" aria-disabled="true">
            ...
            <a href="#" aria-label="Instagram profile coming soon" aria-disabled="true">
            ...
            <a href="#" aria-label="GitHub profile coming soon" aria-disabled="true">
