...
export const metadata: Metadata = {
  title: 'Play Japanese Memory Game',
  description: 'Practice Japanese hiragana, katakana, and kanji with Explore mode and Play mode.',
  alternates: {
    canonical: '/play',
  },
};
        ...
        <div className="app-container">
          <header className="game-toolbar">
            <div className="game-toolbar-copy">
              <span className="card-label">Practice workspace</span>
              <h1>Choose your next rep.</h1>
              <p>Explore to warm up. Play when you want active recall.</p>
            </div>
            <a className="hero-action-secondary" href="/">Home</a>
          </header>
