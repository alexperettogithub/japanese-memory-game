          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;margin:0 auto;background:#fffaf2;border:3px solid #ffffff;border-radius:28px;box-shadow:0 24px 70px rgba(52,24,94,.18);">
            <tr>
              <td style="padding:28px;">
                ...
                <div style="display:inline-block;margin:0 0 18px;padding:8px 12px;border-radius:999px;background:#ffd166;color:#201335;font-size:12px;font-weight:950;line-height:1;letter-spacing:.08em;text-transform:uppercase;">${escapeHtml(eyebrow)}</div>
                <h1 style="margin:0 0 14px;color:#201335;font-size:42px;line-height:.92;letter-spacing:-.06em;font-weight:950;">${escapeHtml(title)}</h1>
                <p style="margin:0 0 26px;color:#6b5f7d;font-size:17px;line-height:1.55;font-weight:750;">${escapeHtml(body)}</p>
                <a href="${safeCtaHref}" style="display:inline-block;padding:15px 22px;border-radius:999px;background:#7c3cff;background-image:linear-gradient(135deg,#7c3cff,#ff4fa3);color:#ffffff;text-decoration:none;font-size:15px;font-weight:950;">${escapeHtml(ctaLabel)}</a>
                <p style="margin:24px 0 0;color:#6b5f7d;font-size:13px;line-height:1.55;font-weight:700;">Japanese Memory Game by Zero Softworks</p>
              </td>
            </tr>
          </table>
        </td>
